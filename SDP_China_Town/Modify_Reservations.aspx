<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Modify_Reservations.aspx.vb" Inherits="SDP_China_Town.WebForm9" %>
         ...
         <div class ="container">
            <div class ="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-center">
               <div class ="banner">
                  ...
                  <h3>Modify existing reservation</h3>
               </div>
            </div>
            <div class ="col-lg-6 col-md-6 col-sm-6 col-xs-12">
               <div class ="formSection">
                ...
                <div class="form-group">
                              ...
                              <div class="col-lg-10">
                                 <asp:TextBox ID="txtType" runat="server" placeholder="Type of Suite" CssClass="form-control" Enabled="false"></asp:TextBox>
                              </div>
                           </div>
                <div class="form-group">
            ...
            <div class="form-group">
                <asp:Button ID="btnSubmit" runat="server" Text="Modify" CssClass="btn btn-warning" Enabled="false"/>
            </div>
                     </fieldset>
                  </div>
               </div>
